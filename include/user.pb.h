...
class AddResponse final :
 ...
 public:
  ...
  int32_t addresult() const;
  void set_addresult(int32_t value);
  private:
  int32_t _internal_addresult() const;
  void _internal_set_addresult(int32_t value);
  public:
...
inline const ::fixbug::ResultCode& AddResponse::_internal_result() const {
...
inline const ::fixbug::ResultCode& AddResponse::result() const {
...
inline void AddResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.AddResponse.result)
}
inline ::fixbug::ResultCode* AddResponse::release_result() {
...
inline ::fixbug::ResultCode* AddResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.AddResponse.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* AddResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* AddResponse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.AddResponse.result)
  return _msg;
}
inline void AddResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.AddResponse.result)
}

// int32 addresult = 2;
inline void AddResponse::clear_addresult() {
  _impl_.addresult_ = 0;
}
inline int32_t AddResponse::_internal_addresult() const {
  return _impl_.addresult_;
}
inline int32_t AddResponse::addresult() const {
  // @@protoc_insertion_point(field_get:fixbug.AddResponse.addresult)
  return _internal_addresult();
}
inline void AddResponse::_internal_set_addresult(int32_t value) {
  
  _impl_.addresult_ = value;
}
inline void AddResponse::set_addresult(int32_t value) {
  _internal_set_addresult(value);
  // @@protoc_insertion_point(field_set:fixbug.AddResponse.addresult)
}
